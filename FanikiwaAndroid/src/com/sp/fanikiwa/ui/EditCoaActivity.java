...
public class EditCoaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_editcoa);
		...
		btnAddCoa.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (coaDescription.length() == 0) {
					Toast.makeText(EditCoaActivity.this,
				...
				new AddCoaAsyncTask(EditCoaActivity.this)
						.execute(params); 
			}
		});

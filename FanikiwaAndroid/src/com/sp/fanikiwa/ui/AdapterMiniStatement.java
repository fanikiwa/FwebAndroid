...
public class AdapterMiniStatement extends BaseAdapter {
	...
	public AdapterMiniStatement(Context context, List<Offer> listOffers) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = this.inflater.inflate(R.layout.itemlendoffer, parent, false);
		...
		holder.txtDescription.setText("Description: " + offer.getDescription().trim());
		holder.txtAmount.setText("Amount: " + offer.getAmount().toString());
		holder.txtTerm.setText("Term: " + offer.getTerm().toString());
		holder.txtInterest.setText("Interest: " + offer.getInterest().toString());

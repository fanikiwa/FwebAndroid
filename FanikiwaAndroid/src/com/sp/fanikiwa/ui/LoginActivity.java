...
public class LoginActivity extends Activity {
	...
	private class LoginAsyncTask extends AsyncTask<String, Void, RequestResult> {
		...
		protected void onPostExecute(RequestResult userprofile) {
			...
			if ((userprofile != null)) {
				...
				prefEditor.putString("Userid", userprofile.getClientToken().toString());
//				prefEditor.putString("Pwd", userprofile.getPassword());
				...
				Intent i = new Intent(getApplicationContext(),
						MainActivity.class);
				i.putExtra(USER_ID, userprofile.getClientToken().toString());
				startActivity(i);

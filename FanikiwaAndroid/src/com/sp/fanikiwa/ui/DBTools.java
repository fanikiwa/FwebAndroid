...
public class DBTools extends SQLiteOpenHelper {
	...
	public DBTools(Context context) {
		super(context, "fanikiwa.db", null, DB_VERSION);
	}
	...
	public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion,
			int newVersion) {
		try {
			System.out.println("UPGRADE DB oldVersion=" + oldVersion
	...
	public void onDowngrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		System.out.println("DOWNGRADE DB oldVersion=" + oldVersion
				+ " - newVersion=" + newVersion);
	}
	...
	public User getUser(String username) {
		String query = "Select userId, password from logins where username ='"
				+ username + "'";
